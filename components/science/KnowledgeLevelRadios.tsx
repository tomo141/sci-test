...
export function KnowledgeLevelRadios({ scope, name, value, onChange, purpose }: {
  ...
  return <fieldset className="grid gap-3">
    ...
    <p className="text-sm leading-7">{purpose === "author" ? "この問題を初めて見て、10人中7人くらいが正解できそうな人物像を1つ選んでください。検索・AIを使わない4択の回答を想定します。" : "それぞれのグループが約70％正解できる問題を想像してください。あなた自身も、10問中7問くらい解けそうなのはどのグループですか？ 学歴に関係なく、今の知識に一番近いものを選べます。"}</p>
