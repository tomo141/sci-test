...
export type AttemptResult = ScienceResult & { answerCount: number; correctCount: number; definition: ExamDefinition; originalAnswerCount?:number; correctionEpoch?:number; corrections?:{count:number;excludedCount:number;updatedAt:string|null} };
