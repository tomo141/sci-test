...
const specs: Spec[] = [
  ...
  { domain: "医歯薬学", subdomain: "感染症", question: "細菌を殺す、または増殖を抑える薬は一般に何と呼ばれる？", choices: ["抗菌薬", "抗ウイルス薬", "抗真菌薬", "抗寄生虫薬"], correct: 0, note: "抗菌薬は細菌感染症に対して使われます。", terms: "抗菌薬：細菌に作用。解熱鎮痛薬：熱や痛みに作用。" },
  ...
  { domain: "人文社会科学", subdomain: "教育学", question: "学習者が自分の学びを振り返って調整することを何という？", choices: ["メタ認知", "作業記憶", "条件づけ", "足場かけ"], correct: 0, note: "メタ認知は自分の認知や学習を客観的に捉える働きです。", terms: "メタ認知：自分の思考を捉えること。振り返り：学習改善に役立つ活動。" }
];
