...
const specs: Spec[] = [
  ...
  { domain: "数学", subdomain: "確率", question: "確率の値として取り得る範囲はどれ？", choices: ["0以上1以下", "1以上2以下", "-1以上1以下", "0以上100以下"], correct: 0, note: "確率は0から1までの値で表します。", terms: "確率0：起こらない。確率1：必ず起こる。" },
  ...
  { domain: "物理", subdomain: "法則", question: "エネルギー保存則として正しい説明はどれ？", choices: ["エネルギーは増減しうる", "エネルギーは形を変えても総量は保存される", "エネルギーは温度が高いほど消滅する", "エネルギーは質量と無関係である"], correct: 1, note: "孤立系ではエネルギーの総量は保存されます。", terms: "保存則：総量が変わらないという法則。エネルギー：仕事をする能力。" },
  ...
  { domain: "工学", subdomain: "製図", question: "CADの主な用途はどれ？", choices: ["設計図の作成", "組立図の作成", "配線図の作成", "工程表の作成"], correct: 0, note: "CADはコンピュータ支援設計に使われます。", terms: "CAD：Computer-Aided Design。CAE：解析支援。" },
  ...
  { domain: "工学", subdomain: "安全", question: "工場などで危険源を事前に洗い出す活動はどれ？", choices: ["リスクアセスメント", "故障モード解析", "ヒューマンエラー分析", "安全パトロール"], correct: 0, note: "リスクアセスメントは危険性を評価し対策する活動です。", terms: "リスク：危険の大きさ。ハザード：危険源。" },
  ...
  { domain: "医歯薬学", subdomain: "免疫", question: "ワクチンで体に作らせたい防御反応はどれ？", choices: ["免疫記憶", "自然免疫", "炎症反応", "アレルギー反応"], correct: 0, note: "ワクチンは免疫記憶を作り、感染時の防御に備えます。", terms: "免疫記憶：再侵入時に速く反応する仕組み。抗体：抗原に結合するタンパク質。" },
  ...
  { domain: "人文社会科学", subdomain: "哲学", question: "功利主義で重視される代表的な基準はどれ？", choices: ["幸福や効用", "義務や原則", "徳や品格", "権利の尊重"], correct: 0, note: "功利主義は幸福や効用の最大化を重視する考え方です。", terms: "功利主義：最大多数の最大幸福。義務論：義務や原則を重視。" },
